...
namespace Vault
{
    ...
    public static class GlobalVDKContext
    {
        ...
        public static string vaultUsername = "hk02"; // Add credentials here for build
        
        public static string vaultPassword = "Hk,2020"; // Add credentials here for build
        ...
        public static string SavedUsernameKey = "hk02";
        public static string SavedPasswordKey = "Hk,2020";
